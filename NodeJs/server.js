...
const PORT = process.env.PORT || 3000; // return given port, or if none then 3000

app.use(express.static(path.join(__dirname, 'public')))
app.use(express.json())

// Add logger? MERN stack minute ~40
...
// Use passport js ?
// app.get('/u_login', (req, res) => { // clearer rename e.g. userlogin or just login or user/login?
//   res.send('<h2>Hello from Express.js server!!</h2>');
//   // index.html
// })
...
//   var path = "../html"+q.pathname+".html";

//   console.log(path);
//   // var txt = query.a + " " + query.b;
//   // res.end(txt);
